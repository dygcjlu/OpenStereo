...
###### huger
python openstereo/main.py --config ./configs/aanet/AANet_custom.yaml --scope train --no_distribute --restore_hint ./model/official/AANet_SceneFlow.pt
python openstereo/main.py --config ./configs/aanet/AANet_custom.yaml --scope test_kitti --no_distribute --restore_hint ./model/AANet_SceneFlow_lamb_b64_288_4e3_epoch_055.pt
